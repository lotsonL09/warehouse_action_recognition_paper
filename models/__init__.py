...
def get_model(model:int,num_classes:int):

    if model == 1:
        return get_custom_mvit(num_classes)
    elif model == 2:
        return get_custom_s3d(num_classes)
    elif model == 3:
        return get_custom_r3d(num_classes)
    elif model == 4:
        return get_custom_video_swin_transformer(num_classes)
    elif model == 5:
        return get_custom_vivit(num_classes)
    else:
